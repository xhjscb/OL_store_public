<template>
    <div>
        ...
        <div class="newopro-r fr" style="display:inline-block;right:500px;">
            <h2 class="index-tt">
                <em class="ft18 c000" style="color:#30444f;font-size:30px;padding:50px;">新品上架</em>
                <router-link to="/app/home/list/more" target = _blank><a  class="fr c666" style="color:#30444f;font-size:15px;padding:10px">更多&gt;&gt;</a></router-link>
            </h2>
